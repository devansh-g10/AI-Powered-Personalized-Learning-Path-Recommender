...
COPY --from=builder /app/dist /usr/share/nginx/html`,
  ...
  return (
    <div className="flex flex-col gap-28 pb-20 w-full relative">
      ...
      <div className="pointer-events-none absolute -top-24 left-1/2 -translate-x-1/2 w-[850px] h-[500px] bg-gradient-to-tr from-[#2b7fff]/20 via-blue-400/15 to-purple-400/10 blur-[130px] rounded-full animate-pulse-glow" />
      <div className="pointer-events-none absolute top-[800px] -right-32 w-[600px] h-[600px] bg-gradient-to-br from-cyan-400/15 to-[#2b7fff]/10 blur-[140px] rounded-full animate-float-slow" />
          ...
          <div className="glass-card rounded-[22px] p-6 sm:p-8 flex flex-col gap-6 text-left">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
              ...
              <div className="lg:col-span-5 rounded-2xl bg-zinc-950 p-4 text-white shadow-xl flex flex-col gap-3 font-mono text-xs border border-zinc-800">
                ...
                <pre className="text-[11px] leading-relaxed text-blue-200 overflow-x-auto whitespace-pre font-mono">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feat) => {
            ...
            return (
              <div
                key={feat.title}
                className="glass-card glass-card-hover rounded-3xl p-6 flex flex-col gap-4 text-left group"
              >
        ...
        <div className="flex flex-col gap-3">
          {faqs.map((faq, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`glass-card rounded-2xl p-5 cursor-pointer transition-all duration-200 border ${
                  isOpen ? "border-[#2b7fff]/40 bg-white/90 shadow-md" : "hover:bg-white/80"
                }`}
      ...
      <section className="relative rounded-[32px] overflow-hidden p-10 sm:p-16 bg-gradient-to-br from-[#111827] via-[#1e3a8a] to-[#2563eb] text-white text-center flex flex-col items-center gap-8 shadow-[0_30px_90px_-20px_rgba(37,99,235,0.45)] border border-white/20 z-10">
        ...
        <div className="pointer-events-none absolute -right-24 -top-24 w-96 h-96 bg-cyan-400/35 rounded-full blur-3xl animate-pulse-glow" />
        <div className="pointer-events-none absolute -left-24 -bottom-24 w-96 h-96 bg-purple-500/35 rounded-full blur-3xl animate-float" />
        ...
        <div className="flex items-center gap-3 flex-wrap justify-center relative z-10">
          <div className="glass-pill px-3.5 py-1.5 rounded-full text-xs font-semibold text-blue-100 flex items-center gap-2 border-white/30 bg-white/10 backdrop-blur-xl">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 pt-4 border-t border-white/15 text-xs text-blue-100 relative z-10">
